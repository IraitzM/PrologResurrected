...
class GameState(rx.State):
    ...
    def start_tutorial(self):
        ...
        self.add_terminal_output("🚀 Starting Hello World Prolog Tutorial...", "cyan")
        ...
        self.add_terminal_output("Type 'next' to continue or 'hint' for guidance.", "cyan")
    ...
    def _handle_tutorial_input(self, input_text: str):
        """Handle input during tutorial mode."""
        # Simple tutorial progression for now
        if input_text.lower() in ["next", "continue", ""]:
            if self.tutorial_session.advance_step():
                ...
                self.add_terminal_output("Type 'menu' to return to main menu.", "green")
                self.set_right_panel(
                    "Congratulations!\n\nYou've completed the Hello World Prolog tutorial.\n\nYou're now ready for the main adventure!", 
                    "neon_yellow", 
                    "COMPLETE"
                )
            ...
            self.add_terminal_output(
                "Type 'next' to continue, 'hint' for guidance, or 'menu' to return.", "yellow"
            )
    ...
    def _show_tutorial_hint(self):
        ...
        hints = {
            0: "This is an introduction to Prolog. Read the explanation on the right, then type 'next' to continue.",
            1: "Learn about Prolog facts - the basic building blocks. Type 'next' when ready to proceed.",
            2: "Time to create your first fact! Follow the instructions in the right panel.",
            3: "Now you'll learn about queries - how to ask questions in Prolog. Type 'next' to continue.",
            4: "Variables are powerful in Prolog. They start with capital letters. Type 'next' to proceed.",
            5: "You're at the completion step. Great job learning the basics!"
        }
        
        hint_text = hints.get(current_step, "Type 'next' to continue through the tutorial.")
        self.set_right_panel(f"💡 HINT\n\n{hint_text}", "neon_yellow", "HINT")
...
The AI system is waiting for you to begin the repair process. Start by exploring the available commands to understand your mission better."""
...
def welcome_screen() -> rx.Component:
    ...
    └─────────────────────────────────────┘
                ...
                # Footer
                neon_text(
                    "Select your mission, programmer...", color="neon_yellow", size="sm"
                ),
                spacing="6",
                align="center",
            ),
